...
import foam.littlej.android.app.entities.Comment;
...
public class CommentDao extends DbContentProvider implements ICommentDao,
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#addComment(java.util.List)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#addComment(com.ushahidi
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#fetchCheckinComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#fetchReportComment(int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#updateCheckinByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#updateCheckinByCheckinId
	 * (int)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see foam.littlej.android.app.database.ICommentDao#deleteAllComment()
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#deleteCommentByReportId
	 * (int)
	 */
	@Override
	 ...
	 * 
	 * @see
	 * foam.littlej.android.app.database.ICommentDao#deleteCommentByCheckinId
	 * (int)
	 */
	@Override
