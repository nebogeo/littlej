...
public class OfflineReportDao extends DbContentProvider implements IOfflineReportDao,
     ...
     * (non-Javadoc)
     * @see
     * foam.littlej.android.app.database.IOfflineReportDao#fetchAllOfflineIncidents
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * foam.littlej.android.app.database.IOfflineReportDao#deleteAllOfflineReport
     * ()
     */
    @Override
     ...
     * (non-Javadoc)
     * @see
     * foam.littlej.android.app.database.IOfflineReportDao#addOfflineReport(
     * foam.littlej.android.app.entities.OfflineReport)
     */
    @Override
